                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li>
                                <!-- copy paste dari welcome.blade.php, nah habis itu di kasi list di tiap element -->
                            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                    <!-- ambil dari dashboard.blade.php, agar bisa user nya login atau logout dari profilnya -->
                        <li><x-app-layout>
